...
class Curl {
    ...
    function __construct($url = '')
    {
        if (!function_exists('curl_init')) {
            throw new NotFoundCurlException('cURL Class - PHP was not built with cURL enabled. Rebuild PHP with --with-curl to use cURL.') ;
        }
    ...
    public function create($url) {
        ...
        // If no a protocol in URL, assume its a host link
...
class NotFoundCurlException extends \Exception{}
